                ...
                <div className='min-vh-100 w-100 d-flex flex-column'>
                    ...
                    <Row className='justify-content-center mt-5' xl='7'>
                        <h2 className='descText'>
                            Sharing a house with mates? <br /> Need to divide
                            financial assets fairly? <br /> We can help.
                        </h2>
                    </Row>

                    <Row
                        className='w-100 align-items-center justify-content-center flex-grow-1'
                        style={{
                            margin: "0",
                            marginTop: "5.85%",
                            padding: "10px 0",
