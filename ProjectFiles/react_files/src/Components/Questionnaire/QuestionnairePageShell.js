    ...
    if(stage < 3) {
        return (
            <Container fluid className="h-100 divBlockWithContentPrimary">
                <Row className="h-100 justify-content-center divBlockWithContentPrimary">
                    <Row className="w-100 divBlockWithContentPrimary justify-content-center" style={{marginBottom: "12.5%", padding: "4% 0 6% 0"}}>
                        ...
                        <Row className=" justify-content-center w-100 divBlockWithContentPrimary" style={{}}>
                            <Col xs={12} sm={4}>
        ...
        return (
            <Container fluid className="divBlockWithContentPrimary" style={{height: "100vh"}}>
                <Row className="align-items-center h-100 justify-content-center divBlockWithContentPrimary">
                    <Row className="justify-content-center w-100 divBlockWithContentPrimary">
                        <Col xs={12} sm={4}>
